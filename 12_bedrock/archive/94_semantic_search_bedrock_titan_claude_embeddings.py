...
# ## Usecase
# #### Dataset
# To explain this architecture pattern we are using PDF documents from IRS. These documents explain topics such as:
# - Original Issue Discount (OID) Instruments
# - Reporting Cash Payments of Over $10,000 to IRS
# - Employer's Tax Guide
# 
# To showcase that we are not bound to a specific domain we also use a txt file containing a cooking recipe for curry. 
# 
# #### Persona
# Let's assume a persona of a layman who doesn't have an understanding of how IRS works and if some actions have implications or not. At the same time she wants to occasionaly use the same system for answering questions related to his sparetime, like cooking her favourite dishes.
# 
...
# 
# For a detailed description on what the following cells do refer to [Bedrock boto3 setup](../00_Intro/bedrock_boto3_setup.ipynb) notebook. ***TODO: ADD LINK TO SETUP NOTEBOOK***``

...
# ### Create Amazon OpenSerach Serverless Index
# 
...
# ### Add OpenSerach Serverless Permissions
# 
...
# 
# To do this, on OpenSearch Serverless console, click into your collection, then on Data Access click on "Manage Data Access".
# 
...
# You've setted Amazon Open Search Policy. Now it's important to setup your role to make sure it has necessary policies to call Amazon Open Search Serverless:
# 

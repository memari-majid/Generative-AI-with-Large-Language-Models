...
%pip install -U datasets #==2.14.1
%pip install -U neuronx-cc #==2.* 
%pip install -U torch-neuronx
...
# from optimum.neuron.utils import is_neuronx_distributed_available, is_torch_xla_available
...
sagemaker_save_dir="./llama2_dolly_neuron"

...
# 
# In this example, we are going to learn how to fine-tune [LLaMA 2](https://huggingface.co/meta-llama/Llama-2-7b-hf) suing Amazon SageMaker. [LLaMA 2](https://huggingface.co/meta-llama/Llama-2-70b-hf) is the next version of the [LLaMA](https://arxiv.org/abs/2302.13971). 
# 
# Compared to the V1 model, it is trained on more data - 2T tokens and supports context length window upto 4K tokens. Learn more about LLaMa 2 in the [""]() blog post.
# 
# In Detail you will learn how to:
# 1. Setup Development Environment
# 2. Load and prepare the dataset
# 3. Fine-Tune LLaMA 7B on Amazon SageMaker with p4d.24xlarge
# 4. Deploy Fine-tuned LLM on Amazon SageMaker
# 
# ### Access LLaMA 2
# 
# Before we can start training we have to make sure that we accepted the license of [llama 2](https://huggingface.co/meta-llama/Llama-2-70-hf) to be able to use it. You can accept the license by clicking on the Agree and access repository button on the model page at: 
# 
# ## 1. Setup Development Environment
...
#model_id = "meta-llama/Llama-2-13b-hf" # gated
...
# ## 3. Fine-Tune LLaMA 7B on Amazon SageMaker with p4d.24xlarge
# 
# We prepared a [train.py](./scripts/train.py), which trains our model. 
# 
